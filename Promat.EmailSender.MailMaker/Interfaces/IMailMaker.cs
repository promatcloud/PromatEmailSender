...
public interface IMailMaker : IDisposable
{
    ...
    /// <param name="headerEnum">Tamaño del título de la cabecera. Por defecto 'h3'</param>
    ...
    /// </summary>
    /// <param name="colorLinea">Color de la línea, si no lo pasamos se utilizan los de <see cref="IMailConfigurator"/></param>
